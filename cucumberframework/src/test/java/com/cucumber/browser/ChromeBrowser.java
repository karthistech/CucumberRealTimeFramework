 ...
 *         Aug 5, 2016
 */
public class ChromeBrowser implements Serializable{
	...
	public WebDriver getChromeDriver(Capabilities cap) {
		System.setProperty("webdriver.chrome.driver",
				FileReaderManager.getFileReaderManager().getConfigFileReader().getDriverPath());
		/*
		 * System.setProperty("webdriver.chrome.logfile",
		 * ResourceHelper.getResourcePath("logs/chromelogs/") + "chromelog" +
